import { IoPieChartSharp, IoMoon } from "react-icons/io5";
...
const About = () => {
  ...
  return (
    <div
      id="features"
      className={`py-12 ${isDarkMode ? "bg-darkBluishGray" : "bg-gray-50"}`}
    >
          ...
          <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                ...
                >
                  Get a bird's eye view of all your social media accounts in one
                  central dashboard.
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                ...
                >
                  Track engagement, reach, and demographic data with beautiful
                  interactive charts.
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                ...
                >
                  Monitor your growth and track performance metrics over time
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                ...
                >
                  Enjoy a comfortable viewing experience day or night with our
                  dark mode option.
                </p>
              </div>
            </div>
