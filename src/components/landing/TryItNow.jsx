...
const TryItNow = () => {
  ...
  return (
    <>
      {/* Call-to-Action (CTA) Section with purple background */}
      <div className="bg-purple-700">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          {/* White text heading with responsive sizing */}
          <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
            <span className="block">Ready to take control of your social media?</span>
          </h2>
          {/* Light purple paragraph text */}
          <p className="mt-4 text-lg leading-6 text-purple-200">
            Start tracking your social media performance today and unlock valuable insights.
          </p>
          {/* White button with purple text and right arrow icon */}
          <Link
            to="/signup"
      ...
      <footer className={`${isDarkMode ? 'bg-navy' : 'bg-white'}`}>
        <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex justify-center space-x-6">
            ...
            <a href="#" className={`${isDarkMode ? 'text-gray-400 hover:text-gray-300' : 'text-gray-400 hover:text-gray-500'}`}>
