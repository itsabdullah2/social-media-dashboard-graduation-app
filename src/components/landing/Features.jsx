...
const Features = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Enjoy a comfortable viewing experience with real-time updates and dark mode support.",
    },
  ];
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div
            className={`h-1 w-20 bg-blueberry mx-auto mt-6 mb-8 rounded-full`}
          ></div>
          <p
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex flex-col h-full">
                  <div className="p-3 rounded-full w-fit mb-4 bg-blueberry">
